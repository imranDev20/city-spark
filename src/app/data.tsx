...
export const cartData = [
  {
    id: 1,
    name: "Line Up",
    src: "https://www.kubota-chemix.co.jp/dcms_media/image/lineup_img01.png",
    description:
  ...
  },
  {
    id: 2,
    name: "Gate ball",
    src: "https://www.shutterstock.com/image-photo/water-valve-fittings-products-photograph-260nw-2349895553.jpg",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut",
    price: 300,
  },
  {
    id: 3,
    name: "Skipper pipes",
    src: "https://skipperpipes.in/wp-content/uploads/2019/06/upvc-main-1.jpg",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut",
    price: 400,
  },
