...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-white transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
      "border-gray-200 hover:bg-gray-100 text-gray-900",
      "group-[.info]:border-blue-200 group-[.info]:hover:bg-blue-100 group-[.info]:text-blue-900",
      "group-[.success]:border-green-200 group-[.success]:hover:bg-green-100 group-[.success]:text-green-900",
      "group-[.warning]:border-yellow-200 group-[.warning]:hover:bg-yellow-100 group-[.warning]:text-yellow-900",
      "group-[.destructive]:border-red-200 group-[.destructive]:hover:bg-red-100 group-[.destructive]:text-red-900",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "group-[.info]:text-blue-500 group-[.info]:hover:text-blue-900",
      "group-[.success]:text-green-500 group-[.success]:hover:text-green-900",
      "group-[.warning]:text-yellow-500 group-[.warning]:hover:text-yellow-900",
      "group-[.destructive]:text-red-500 group-[.destructive]:hover:text-red-900",
      className
    )}
    toast-close=""
    {...props}
...
>(({ variant, children, ...props }, ref) => (
  <Toast variant={variant} ref={ref} {...props}>
